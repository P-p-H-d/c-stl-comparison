...
const config_func_t table[] = {
  ...
  { 602,    "Queue(Buffer P2)", SIZE_LIMIT+1000000, 0, test_buffer, 0},
  { 603,"Queue(MPMC P2)", SIZE_LIMIT+1000000, 0, test_queue, 0},
  { 604,"Queue(SPSC P2)", 1000000, 0, test_queue_single, 0},
