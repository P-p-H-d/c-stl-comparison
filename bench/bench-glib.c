...
const config_func_t table[] = {
  ...
  { 200,  "SSet(GTree)", 1000000, 0, test_rbtree, 0},
  { 300,    "UMap U64(GHashTable)", 10000000, 0, test_dict, 0},
  { 320, "UMap Big(GHashTable)", 1000000, 0, test_dict_big, 0},
  { 500,           "Sort",10000000, 0, test_sort, 0},
};

int main(int argc, const char *argv[])
{
  test("GLIB", numberof(table), table, argc, argv);
  exit(0);
}
